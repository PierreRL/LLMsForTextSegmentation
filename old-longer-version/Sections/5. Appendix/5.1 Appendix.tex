...
\begin{enumerate}
    ...
    \item Segments are validated. This means they must not be too long nor too short (> 50 tokens, < 750 tokens) and that they should not contain too many punctuation marks as a proportion of the segment length. We arbitrarily set this to 50\% of the characters in a segment.
