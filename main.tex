...
% 1
% ---------- Introduction ----------
\input{Sections/1_Introduction/1_1_Motivation.tex}
\input{Sections/1_Introduction/1_2_Topic_Segmentation_Problem}
\input{Sections/Figures_and_Tables/main_figure.tex}
\input{Sections/1_Introduction/1_3_Related_Work}
\input{Sections/Figures_and_Tables/results_table.tex}
% 2
% ---------- Method ----------
\section{Method}
\input{Sections/2_Method/2_1_Datasets}
\input{Sections/2_Method/2_2_Evaluation}
\input{Sections/2_Method/2_3_LLM-Based_Text_Segmentation}

% 3. Experiments
\section{Experiments}\label{Results}
\input{Sections/3_Experiments/3_1_Models}
\input{Sections/3_Experiments/3_2_Results}

% 4. Conclusion
\section{Conclusion}\label{Conclusion}
\input{Sections/4_Conclusion/Conclusion}
% 5. Appendices
\input{Sections/5_Appendices/5_1_Ethics_Statement}
\input{Sections/5_Appendices/5_2_Limitations}
\input{Sections/5_Appendices/5_3_Acknowledgements}

% Bibliography
\bibliography{custom}

\appendix
\input{Sections/5_Appendices/5_4_Appendix}
