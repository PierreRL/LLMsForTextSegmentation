...
\input{Sections/1. Introduction/1.2 Topic Segmentation Problem}
\input{Sections/Figures_and_Tables/main_figure.tex}
\input{Sections/1. Introduction/1.3 Related Work}
...
\input{Sections/4. Conclusion/Conclusion}

% 5. Appendices
\input{Sections/5. Appendices/5.1 Ethics Statement}
\input{Sections/5. Appendices/5.2 Limitations}
\input{Sections/5. Appendices/5.3 Acknowledgements}

% Bibliography
\bibliography{custom}

\appendix
\input{Sections/5. Appendices/5.4 Appendix}
